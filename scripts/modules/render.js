import {getCurrentDateTime, getDewPointTemperature, getDirectionWind} from './utilis.js';
  ...
  widget.insertAdjacentHTML(
      ...
      <div class="widget__other">
        <div class="widget__wind">
          ...
          <p class="widget__wind-text">${getDirectionWind(data.wind.deg)}</p>
        ...
        <div class="widget__humidity">
          ...
          <p class="widget__humidity-text">Т.Р: 
            ${getDewPointTemperature((data.main.feels_like - 273.15), data.main.humidity).toFixed(1)} 
            °C</p>
        </div>
